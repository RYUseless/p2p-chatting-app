...
class AesKeyManagerImpl : KeyManager {
    ...
    override fun computeVerifier(password: String, salt: ByteArray): String        = TODO("iOS: Keychain")
    override fun deriveAesKey(password: String, salt: ByteArray): ByteArray        = TODO("iOS: Keychain")
}